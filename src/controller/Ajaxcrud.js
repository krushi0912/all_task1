...
const ajax_submitform = async (req,res)=>{
    ...
    return res.json({msg:"form submiited!!"})
}
...
const listdata = async (req,res)=>{
    ...
    result = data[0];
    res.render("ajax_form_details",{result});
}

const ajax_employeedata = async (req,res)=>{
    ...
    res.render("ajax_form",{result,result2,result3,result4,result5,hindi,english,gujarati,php,mysql,laravel,oracle,result,result7})
}

const ajax_updatedata = async (req,res)=>{
    var { firstname, lastname, designation, email, phonenumber, address1, address2, city, state, zipcode, gender, dob, Relationshipstatus } = req.body;
...
module.exports = {ajax_getform,ajax_submitform,listdata,ajax_employeedata,ajax_updatedata};